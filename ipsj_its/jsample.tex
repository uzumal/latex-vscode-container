...
\title{狭小空間監視のためのドローンを利用したAR可視化手法の実装と評価}
...
\author{竹内 一真}{Kazuma Takeuchi}{IPSJ}[joho.taro@ipsj.or.jp]
\author{滕 睿}{Rui Teng}{IPSJ}
\author{佐藤 健哉}{Kenya Sato}{IPSJ,JU}[gakkai.jiro@ipsj.or.jp]
